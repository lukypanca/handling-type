...
const InsertHandlingSettingCms = `
		INSERT INTO MUFCMS.AR_HANDLING_SETTING (
			HANDLING_SETTING_ID,
			DESC_HANDLING, 
			TIPE_HANDLING,
			TIPE_HANDLING_ID,
...
`
const InsertTipeNasabahQueryCms = `
...
const InsertCollScoringQueryCms = `
...
`
const InsertPaymentTypeQueryCms = `
...
const InsertTipePembiayaanQueryCms = `
...
const InsertSkemaPembiayaanQueryCms = `
...
const InsertGolonganProductQueryCms = `
...
const InsertBankPendanaanQueryCms = `
...
`
const InsertArExcludeContract = `
	INSERT INTO MUFCMS.AR_EXCLUDE_CONTRACT (
		CONTRACT_NO,
		NAMA_NASABAH,
		OBJECT_GROUP,
		TIPE_NASABAH,
